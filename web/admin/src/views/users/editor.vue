      ...
      <el-col :span="7">
          <el-card class="box-card-component">
            ...
            <el-row style="margin-top:20px;">
              ...
              <el-button type="primary" style="float:right" @click="handleSave">
                Salvar
              </el-button>
            </el-row>
          </el-card>
